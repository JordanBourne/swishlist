...
config :swishlist, SwishlistWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "eDAuty99btS0ERDcENWsCUTfpsFOR+nFbIPWKuiZQwIgh8WAXw1eRwq+V1vaLEPm",
  watchers: [
...
config :swishlist, SwishlistWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/swishlist_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :swishlist, dev_routes: true
